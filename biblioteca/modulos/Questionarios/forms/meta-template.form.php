<div id="MetaCampo_<?=$dados["meta_id"]?>">
    ...
    <div class="pull-left margin-right-10px">
        <label class="control-label" for="Meta_Valor_<?=$dados["meta_id"]?>">Valor</label>
        <input class="form-control" type="text" id="Meta_Valor" name="Meta_Valor[]" value="<?=$dados["registro"]["Valor"]?>">
    </div>
    ...
    <div class="form-group">
        <label class="control-label" for="Meta_Titulo_<?=$dados["meta_id"]?>">Pergunta</label>
        <textarea class="form-control" rows="2" id="Meta_Titulo_<?=$dados["meta_id"]?>" name="Meta_Titulo[]" ><?=$dados["registro"]["Titulo"]?></textarea>
    </div>
    <div class="form-group">
        <label class="control-label" for="Meta_Texto_<?=$dados["meta_id"]?>">Complemento</label>
        <textarea class="form-control ck-small" rows="5" id="Meta_Texto_<?=$dados["meta_id"]?>" name="Meta_Texto[]"><?=$dados["registro"]["Texto"]?></textarea>
    </div>
    <hr>
</div>
